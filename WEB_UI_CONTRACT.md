...
- `LOCAL_API_CONTRACT.md` defines the payloads the UI consumes.
- `DAEMON_CONTRACT.md` defines the local process that hosts the API.
- `TUI_CONTRACT.md` defines the alternative read-only terminal browser.
